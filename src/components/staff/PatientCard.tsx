...
export default function PatientCard({ session, onExpired, onDeleted, onToast }: PatientCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Timer + Last Activity */}
      <div className="px-4 py-2 bg-gray-50 border-b border-gray-100 flex items-center gap-4 justify-between">
      ...
      <div className="px-4 py-3 border-t border-gray-100 space-y-2">
		...
		<div className="flex items-center gap-1.5 flex-wrap">
		  ...
		  <button
		    ...
		    className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold transition-colors duration-200"
		  >
